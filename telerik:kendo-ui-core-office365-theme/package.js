Package.describe({
  name: "telerik:kendo-ui-core-office365-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/kendo.office365.min.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/styles/Office365/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Office365/sprite_kpi_2x.png', 'client');
