...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/BlueOpal/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/BlueOpal/sprite_kpi_2x.png', 'client');
