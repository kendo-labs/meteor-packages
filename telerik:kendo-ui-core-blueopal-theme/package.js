Package.describe({
  name: "telerik:kendo-ui-core-blueopal-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.blueopal.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/BlueOpal/sprite_kpi_2x.png', 'client');
