Package.describe({
  name: "telerik:kendo-ui-core-silver-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.silver.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/Silver/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Silver/sprite_kpi_2x.png', 'client');
