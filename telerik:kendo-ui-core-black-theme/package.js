Package.describe({
  name: "telerik:kendo-ui-core-black-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.black.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/Black/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Black/sprite_kpi_2x.png', 'client');
