Package.describe({
  name: "telerik:kendo-ui-core-uniform-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Uniform/sprite_kpi_2x.png', 'client');
