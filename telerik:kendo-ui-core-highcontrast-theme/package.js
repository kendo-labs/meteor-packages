...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/kendo.highcontrast.min.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/styles/HighContrast/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/HighContrast/sprite_kpi_2x.png', 'client');
