Package.describe({
  name: "telerik:kendo-ui-core-metro-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.metro.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/Metro/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Metro/sprite_kpi_2x.png', 'client');
