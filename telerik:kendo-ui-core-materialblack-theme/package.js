...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/MaterialBlack/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MaterialBlack/sprite_kpi_2x.png', 'client');
