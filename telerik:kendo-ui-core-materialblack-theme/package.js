...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.materialblack.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MaterialBlack/sprite_kpi_2x.png', 'client');
