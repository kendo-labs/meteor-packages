Package.describe({
  name: "telerik:kendo-ui-core-fiori-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/kendo.fiori.min.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/styles/Fiori/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/Fiori/sprite_kpi_2x.png', 'client');
