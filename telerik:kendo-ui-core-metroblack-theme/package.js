...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/styles/MetroBlack/editor.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/styles/MetroBlack/sprite_kpi_2x.png', 'client');
