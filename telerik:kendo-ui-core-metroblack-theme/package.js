Package.describe({
  name: "telerik:kendo-ui-core-metroblack-theme",
...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.metroblack.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/MetroBlack/sprite_kpi_2x.png', 'client');
