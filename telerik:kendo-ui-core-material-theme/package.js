...
Package.onUse(function (api) {
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/kendo.material.css', 'client');
  ...
  api.add_files('telerik.kendoui.core/src/styles/web/Material/editor.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/imagebrowser.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/indeterminate.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/loading-image.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/loading.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/loading_2x.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/slider-h.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/slider-v.gif', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/sprite.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/sprite_2x.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/sprite_kpi.png', 'client');

  api.add_files('telerik.kendoui.core/src/styles/web/Material/sprite_kpi_2x.png', 'client');
